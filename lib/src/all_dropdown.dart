...
class AllDropdown<T> extends StatefulWidget {
  ...
  /// Show selected value in the text field
  final bool showSelectedInTextField;
  ...
  /// Custom validator for form field integration
  ...
  const AllDropdown({
    ...
    this.emptyBuilder,
    this.dropdownWidth,
    this.showSelectedInTextField = true,
    this.suffixIcon,
    this.enabled = true,
  ...
  @override
  State<AllDropdown<T>> createState() => _AllDropdownState<T>();
}

class _AllDropdownState<T> extends State<AllDropdown<T>> {
  ...
  @override
  void didUpdateWidget(AllDropdown<T> oldWidget) {
